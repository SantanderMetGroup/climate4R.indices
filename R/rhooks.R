...
.onAttach <- function(...) {
    ...
    packageStartupMessage("Use 'indexShow()' for an overview of the available ETCCDI indices and indexCircShow() for the circulation indices")
}
# End
